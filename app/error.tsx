...
export default function Error({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="mb-4 font-display text-2xl italic text-ink">That didn&apos;t load right.</h1>
      <p className="mb-6 max-w-sm text-sm text-ink-soft">
        Nothing was changed — it&apos;s safe to try again. If this keeps happening, the error
